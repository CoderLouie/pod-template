...
public extension SwiftyFitsize {
    ...
    @objc func sf_safeInsetT() -> CGFloat {
        Screen.safeAreaT
    }
    @objc func sf_safeInsetB() -> CGFloat {
        Screen.safeAreaB
    }
    @objc func sf_font(_ font: UIFont) -> UIFont {
        font.fit
    }
    
    @objc func sf_navbarH() -> CGFloat {
        Screen.navbarH
    }
    @objc func sf_tabbarH() -> CGFloat {
        Screen.tabbarH
    }
}
