...
public enum Permission {
    ...
    private final class LocationManager: NSObject, CLLocationManagerDelegate {
        ...
        func requestPermission(way: AuthorizationStatus.LocationWay, completion: @escaping (AuthorizationStatus) -> Void) {
    ...
    private static func _requestLocation(way: AuthorizationStatus.LocationWay, completion: @escaping CompletionHandler) {
    ...
    public static func requestLocation(way: AuthorizationStatus.LocationWay, completion: @escaping CompletionHandler) {
    ...
    public static func updateLocation(way: AuthorizationStatus.LocationWay, completion: @escaping (Result<[String: String], Error>?, AuthorizationStatus, Bool) -> Void) {
        _requestLocation(way: way) { status, isFirst in
